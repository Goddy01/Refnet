...
export default function HomeSection2() {
  ...
  return (
    <div className='min-h-screen p-4 bg-gradient-to-r from-blue-500 to-blue-700 pt-[3rem] flex flex-col items-center justify-center py-[10vh]'>
      <div className='container mx-auto'>
        <h2 className='text-4xl font-bold text-center mb-8 text-gray-100 tracking-wider font-poppins'>
          HOW IT WORKS
        </h2>
